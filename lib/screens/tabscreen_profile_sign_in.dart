...
class TabScreenProfileSignIn extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => _TabScreenProfileSignIn();
}

enum SubmitButtonState { Waiting, Working }

class _TabScreenProfileSignIn extends State<TabScreenProfileSignIn> {
                    ...
                    children: <Widget>[
                      ...
                      Container(
                        ...
                        child: Text(_formError == null ? '' : formError,
                            textAlign: TextAlign.center,
                            style:
                                TextStyle(color: TrailAppSettings.errorColor)),
                      ),
                      SizedBox(height: 6.0),
                      Divider(
                        color: Colors.grey,
