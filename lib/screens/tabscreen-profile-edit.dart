                          ...
                          child: Column(
                            children: <Widget>[
                              TextFormField(
                                ...
                                onSaved: (value) =>  _userDataBloc.updateDisplayName(value),
                              ),
                              TextFormField(
                                decoration: InputDecoration(
                                  labelText: "Location",
                                ...
                                maxLength: 100,
                                onSaved: (value) => _userDataBloc.updateLocation(value),
                              ),
                              TextFormField(
                                decoration: InputDecoration(
                                ...
                                onSaved: (value) => _userDataBloc.updateDob(value),                                
                              ),
                              TextFormField(
                                decoration: InputDecoration(
                                  labelText: "About You",
                                ...
                                minLines: 1,
                                maxLength: 140,
                                onSaved: (value) => _userDataBloc.updateAboutYou(value),
                              ),
                            ],
                          ),
                        ),
