...
class TrailListViewState extends State<TrailListView> {
  ...
  Widget _trailList = Center(child: CircularProgressIndicator());
  ...
  void _refreshScreen() {
    // Clear the screen
    setState(() {
      _trailList = Center(child: CircularProgressIndicator());
    });
    // Sort the places
    sortPlaces();
    // Return the screen
  ...
  Widget buidTrailList() {
    return RefreshIndicator(
      onRefresh: () {
        setState(() {
          this._trailList = Center(child: CircularProgressIndicator());
        });
