        ...
        children: [
          ...
          TrailPlaceArea(
            ...
            child: TrailPlaceExternalLinkArea(
              ...
              content: place.phones != null && place.phones.length > 0
                  ...
                  : Text(""),
              onPress: () {
                String flatNumber = place.phones.values.first.replaceAll(RegExp(r'[^0-9]'), '');
          ...
          TrailPlaceArea(
            ...
            child: TrailPlaceExternalLinkArea(
              ...
              onPress: () async {
                ...
                String fallbackUrl = "https://www.facebook.com/${place.connections['facebook']}";
                if (Platform.isAndroid) {
                  fbProtocolUrl = "fb://page/${place.connections['facebook']}";
                } else if (Platform.isIOS) {
                  fbProtocolUrl = "fb://profile/${place.connections['facebook']}";
                } else {
          ...
          TrailPlaceArea(
            ...
            child: TrailPlaceExternalLinkArea(
                ...
                content: Text(place.name) ?? "",
                onPress: () {
                  launch(place.connections['untappd']);
                }),
          ),
          // Youtube
          TrailPlaceArea(
