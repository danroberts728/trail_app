    ...
    return ListView(
      children: [
        Container(
          ...
          child: Text(
            "This information is provided by the venue's point of sale system. The accuracy of the listings and prices is not guaranteed.",
            style: TextStyle(
              fontSize: 14.0,
                      ...
                      Visibility(
                        ...
                        child: InkWell(
                          onTap: () async {
                            ...
                            String untappdId = tap.untappdUrl.split("/").last;
                            String launchUrl;
                            String fallbackUrl =
                                "https://untappd.com/beer/$untappdId";
