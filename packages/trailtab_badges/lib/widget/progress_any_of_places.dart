...
import 'package:trailtab_badges/bloc/trophy_progress_checkins_bloc.dart';
import 'package:trail_database/domain/trail_trophy_any_of_places.dart';
import 'package:trailtab_places/trailtab_places.dart';
import 'package:trailtab_badges/widget/trophy_place_item.dart';
import 'package:flutter/material.dart';

class TrailTrophyProgressAnyOfPlaces extends StatelessWidget {
  final TrailTrophyAnyOfPlaces trophy;

  const TrailTrophyProgressAnyOfPlaces({Key key, this.trophy})
      : super(key: key);
      ...
      builder:
        ...
        if (snapshot.connectionState == ConnectionState.waiting) {
          ...
          return ListView.builder(
            ...
            shrinkWrap: true,
            itemCount: trophy.possiblePlaces.length,
            itemBuilder: (context, index) {
              if (snapshot.connectionState == ConnectionState.waiting) {
                return Center(child: CircularProgressIndicator());
              }
              var trophyPlaces = trophy.possiblePlaces..sort();
